...
public class QuesSix {
	...
	public static void main(String[] args) throws AWTException, InterruptedException, IOException {
		...
		WebElement cour = dr.findElement(By.xpath("(//a[text()='Courses '])[1]"));
		act.moveToElement(cour).perform();
		WebElement ora = dr.findElement(By.xpath("(//a[text()='Oracle Training '])[1]"));
		act.moveToElement(ora).perform();
		TakesScreenshot tk=(TakesScreenshot)dr;
		File src = tk.getScreenshotAs(OutputType.FILE);
		File des=new File("C:\\Users\\Sindhu\\eclipse-workspace\\Selenium\\Screenshot\\oracle.png");
